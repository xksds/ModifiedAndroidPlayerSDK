...
int J4A_loadClass__J4AC_com_nio_player_misc_IMediaDataSource(JNIEnv *env)
{
    int         ret                   = -1;
    ...
    sign = "com/nio/player/BasicClasses/IMediaDataSource";
    ...
    J4A_ALOGD("J4ALoader: OK: '%s' loaded\n", "com.nio.player.misc.IMediaDataSource");
    ret = 0;
fail:
    return ret;
}
