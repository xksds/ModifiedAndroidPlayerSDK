...
#define JNI_MODULE_PACKAGE      "com/nio/player"
#define JNI_CLASS_IJKPLAYER     "com/nio/player/NIOMediaPlayer"
#define JNI_IJK_MEDIA_EXCEPTION "com/nio/player/NIOMediaException"
...
static void
NioMediaPlayer_setDataSourceAndHeaders(
...
static void
NioMediaPlayer_setDataSourceFd(JNIEnv *env, jobject thiz, jint fd)
{
    MPTRACE("%s\n", __func__);
    int retval = 0;
    int dupFd = 0;
...
static void
NioMediaPlayer_setDataSourceCallback(JNIEnv *env, jobject thiz, jobject callback)
{
    MPTRACE("%s\n", __func__);
    int retval = 0;
    char uri[128];
...
static void
NioMediaPlayer_setAndroidIOCallback(JNIEnv *env, jobject thiz, jobject callback) {
    MPTRACE("%s\n", __func__);
    int64_t nativeAndroidIO = 0;
...
static void
NioMediaPlayer_setVideoSurface(JNIEnv *env, jobject thiz, jobject jsurface)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_prepareAsync(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
    int retval = 0;
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_start(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_stop(JNIEnv *env, jobject thiz)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_pause(JNIEnv *env, jobject thiz)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_seekTo(JNIEnv *env, jobject thiz, jlong msec)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jboolean
NioMediaPlayer_isPlaying(JNIEnv *env, jobject thiz)
{
...
static jlong
NioMediaPlayer_getCurrentPosition(JNIEnv *env, jobject thiz)
{
    jlong retval = 0;
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jlong
NioMediaPlayer_getDuration(JNIEnv *env, jobject thiz)
{
    jlong retval = 0;
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_release(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    if (!mp)
...
static void NioMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this);
static void
NioMediaPlayer_reset(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    if (!mp)
    ...
    NioMediaPlayer_release(env, thiz);
    NioMediaPlayer_native_setup(env, thiz, weak_thiz);

    ijkmp_dec_ref_p(&mp);
}

static void
NioMediaPlayer_setLoopCount(JNIEnv *env, jobject thiz, jint loop_count)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jint
NioMediaPlayer_getLoopCount(JNIEnv *env, jobject thiz)
{
    jint loop_count = 1;
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jfloat
NioMediaPlayer_getPropertyFloat(JNIEnv *env, jobject thiz, jint id, jfloat default_value)
{
...
static void
NioMediaPlayer_setPropertyFloat(JNIEnv *env, jobject thiz, jint id, jfloat value)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jlong
NioMediaPlayer_getPropertyLong(JNIEnv *env, jobject thiz, jint id, jlong default_value)
{
...
static void
NioMediaPlayer_setPropertyLong(JNIEnv *env, jobject thiz, jint id, jlong value)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_setStreamSelected(JNIEnv *env, jobject thiz, jint stream, jboolean selected)
{
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    int ret = 0;
...
static void
NioMediaPlayer_setVolume(JNIEnv *env, jobject thiz, jfloat leftVolume, jfloat rightVolume)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static jint
NioMediaPlayer_getAudioSessionId(JNIEnv *env, jobject thiz)
{
...
static void
NioMediaPlayer_setOption(JNIEnv *env, jobject thiz, jint category, jobject name, jobject value)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
...
static void
NioMediaPlayer_setOptionLong(JNIEnv *env, jobject thiz, jint category, jobject name, jlong value)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    const char *c_name = NULL;
...
static jstring
NioMediaPlayer_getColorFormatName(JNIEnv *env, jclass clazz, jint mediaCodecColorFormat)
{
...
static jstring
NioMediaPlayer_getVideoCodecInfo(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
...
static jstring
NioMediaPlayer_getAudioCodecInfo(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
    jstring jcodec_info = NULL;
    int ret = 0;
...
static jobject
NioMediaPlayer_getMediaMeta(JNIEnv *env, jobject thiz)
{
    MPTRACE("%s\n", __func__);
...
static void
NioMediaPlayer_native_init(JNIEnv *env)
{
    MPTRACE("%s\n", __func__);
}

static void
NioMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this)
{
    MPTRACE("%s\n", __func__);
...
static void
NioMediaPlayer_native_finalize(JNIEnv *env, jobject thiz, jobject name, jobject value)
{
    MPTRACE("%s\n", __func__);
    NioMediaPlayer_release(env, thiz);
}
...
static void
NioMediaPlayer_native_profileBegin(JNIEnv *env, jclass clazz, jstring libName)
{
    MPTRACE("%s\n", __func__);
...
static void
NioMediaPlayer_native_profileEnd(JNIEnv *env, jclass clazz)
{
    MPTRACE("%s\n", __func__);
...
static void
NioMediaPlayer_native_setLogLevel(JNIEnv *env, jclass clazz, jint level)
{
    MPTRACE("%s(%d)\n", __func__, level);
...
static void
NioMediaPlayer_setFrameAtTime(JNIEnv *env, jobject thiz, jstring path, jlong start_time, jlong end_time, jint num, jint definition) {
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    const char *c_path = NULL;
...
static JNINativeMethod g_methods[] = {
    {
        ...
        (void *) NioMediaPlayer_setDataSourceAndHeaders
    },
    { "_setDataSourceFd",       "(I)V",     (void *) NioMediaPlayer_setDataSourceFd },
    { "_setDataSource",         "(Lcom/nio/player/BasicClasses/IMediaDataSource;)V", (void *)NioMediaPlayer_setDataSourceCallback },
    { "_setAndroidIOCallback",  "(Lcom/nio/player/BasicClasses/IAndroidIO;)V", (void *)NioMediaPlayer_setAndroidIOCallback },

    { "_setVideoSurface",       "(Landroid/view/Surface;)V", (void *) NioMediaPlayer_setVideoSurface },
    { "_prepareAsync",          "()V",      (void *) NioMediaPlayer_prepareAsync },
    { "_start",                 "()V",      (void *) NioMediaPlayer_start },
    { "_stop",                  "()V",      (void *) NioMediaPlayer_stop },
    { "seekTo",                 "(J)V",     (void *) NioMediaPlayer_seekTo },
    { "_pause",                 "()V",      (void *) NioMediaPlayer_pause },
    { "isPlaying",              "()Z",      (void *) NioMediaPlayer_isPlaying },
    { "getCurrentPosition",     "()J",      (void *) NioMediaPlayer_getCurrentPosition },
    { "getDuration",            "()J",      (void *) NioMediaPlayer_getDuration },
    { "_release",               "()V",      (void *) NioMediaPlayer_release },
    { "_reset",                 "()V",      (void *) NioMediaPlayer_reset },
    { "setVolume",              "(FF)V",    (void *) NioMediaPlayer_setVolume },
    { "getAudioSessionId",      "()I",      (void *) NioMediaPlayer_getAudioSessionId },
    { "native_init",            "()V",      (void *) NioMediaPlayer_native_init },
    { "native_setup",           "(Ljava/lang/Object;)V", (void *) NioMediaPlayer_native_setup },
    { "native_finalize",        "()V",      (void *) NioMediaPlayer_native_finalize },

    { "_setOption",             "(ILjava/lang/String;Ljava/lang/String;)V", (void *) NioMediaPlayer_setOption },
    { "_setOption",             "(ILjava/lang/String;J)V",                  (void *) NioMediaPlayer_setOptionLong },

    { "_getColorFormatName",    "(I)Ljava/lang/String;",    (void *) NioMediaPlayer_getColorFormatName },
    { "_getVideoCodecInfo",     "()Ljava/lang/String;",     (void *) NioMediaPlayer_getVideoCodecInfo },
    { "_getAudioCodecInfo",     "()Ljava/lang/String;",     (void *) NioMediaPlayer_getAudioCodecInfo },
    { "_getMediaMeta",          "()Landroid/os/Bundle;",    (void *) NioMediaPlayer_getMediaMeta },
    { "_setLoopCount",          "(I)V",                     (void *) NioMediaPlayer_setLoopCount },
    { "_getLoopCount",          "()I",                      (void *) NioMediaPlayer_getLoopCount },
    { "_getPropertyFloat",      "(IF)F",                    (void *) NioMediaPlayer_getPropertyFloat },
    { "_setPropertyFloat",      "(IF)V",                    (void *) NioMediaPlayer_setPropertyFloat },
    { "_getPropertyLong",       "(IJ)J",                    (void *) NioMediaPlayer_getPropertyLong },
    { "_setPropertyLong",       "(IJ)V",                    (void *) NioMediaPlayer_setPropertyLong },
    { "_setStreamSelected",     "(IZ)V",                    (void *) NioMediaPlayer_setStreamSelected },

    { "native_profileBegin",    "(Ljava/lang/String;)V",    (void *) NioMediaPlayer_native_profileBegin },
    { "native_profileEnd",      "()V",                      (void *) NioMediaPlayer_native_profileEnd },

    { "native_setLogLevel",     "(I)V",                     (void *) NioMediaPlayer_native_setLogLevel },
    { "_setFrameAtTime",        "(Ljava/lang/String;JJII)V", (void *) NioMediaPlayer_setFrameAtTime },
};
